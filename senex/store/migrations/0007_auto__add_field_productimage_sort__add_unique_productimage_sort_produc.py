...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductImage.sort'
        db.add_column(u'store_productimage', 'sort',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding unique constraint on 'ProductImage', fields ['sort', 'product']
        db.create_unique(u'store_productimage', ['sort', 'product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProductImage', fields ['sort', 'product']
        db.delete_unique(u'store_productimage', ['sort', 'product_id'])

        # Deleting field 'ProductImage.sort'
        db.delete_column(u'store_productimage', 'sort')
