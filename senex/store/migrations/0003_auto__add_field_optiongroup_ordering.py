...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OptionGroup.ordering'
        db.add_column(u'store_optiongroup', 'ordering',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OptionGroup.ordering'
        db.delete_column(u'store_optiongroup', 'ordering')
